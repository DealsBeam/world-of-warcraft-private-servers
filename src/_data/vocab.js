...
const GAMES = ["wow", "sc", "diablo", "overwatch", "warcraft3", "hardware", "software", "other"];
const GAME_LABELS = { wow: "WoW", sc: "StarCraft", diablo: "Diablo", overwatch: "Overwatch", warcraft3: "Warcraft III", hardware: "Hardware", software: "Software", other: "Roundup" };
