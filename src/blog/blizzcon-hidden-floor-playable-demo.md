...
Watch what appears on `blizzcon.com/schedule` after Opening Ceremony. If a "World of Warcraft Classic — What's Next" panel appears at 13:00-14:00 Sep 12 in Hall A or C, that is the reveal's second hour. If a "Hands-on: Classic Plus" block appears on the floor map at the same time as the hidden area, that is the playable. The schedule freeze is not a delay; it is a clock that starts at 10:30 and ends when the hidden area is drawn.
