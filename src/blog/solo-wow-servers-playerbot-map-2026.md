...
- [Warstorm](/servers/warstorm/) 3.3.5 — AI bots for quests, dungeons, raids, BGs.
- [SoloCraft](/servers/solocraft/) 1.12.1 — PlayerBots + BattleBots, all content.
- [Hellgarve](/servers/hellgarve/) 7.3.5 — all content soloable. Legion-client solo niche with SkyBlood below.
...
- Shatterspear 3.3.5 — up to 4 bots for hire.
- Synastria 3.3.5 — infinite progression, every raid eventually soloable. Registration disabled — too popular.

## Dead (RIP section)

- Ascension 3.3.5 — Manastorm solo dungeons + custom skills. [Shutdown post-mortem](/blog/ascension-shutdown-explained/).
- MafWow 3.3.5 — alt-as-bot system. Unverified, hofls-reported.
- Valanior — hofls marks RIP, but official site live with ~969 Discord online Sep 2026. Conflict noted, tracker keeps playable until proven otherwise.
- Veritas 3.3.5 — BG + dungeon bots. Unverified, hofls-reported.
