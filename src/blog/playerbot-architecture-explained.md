...
TODO: Deep dive. Cover playerbots (mod-playerbots on AzerothCore), bot AI tiers (rotation scripts → encounter strategy execution), performance costs, and the P2W/bot-abuse line servers walk.
