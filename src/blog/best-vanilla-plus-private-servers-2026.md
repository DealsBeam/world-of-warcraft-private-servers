...
Turtle WoW's code survived its shutdown — the 2024 source leak meant the scene could carry on. These are the direct descendants:
...
Not everything Vanilla+ traces to Turtle. These are built on their own foundations:

- **[SandWorlds](/servers/sandworlds/)** — a Brazilian Vanilla+ realm on the 1.17.2 client with cross-faction play, 13 custom zones, and class reworks.
- **[Project Legacy](/servers/project-legacy/)** — an independent Vanilla+ project on VMaNGOS with 150+ new quests, cross-faction, dual spec, and Prestige/Lorewalker modes.
- **[Incursion-WoW](/servers/incursion-wow/)** — instant-60 Vanilla→WotLK progressive play with reworked MC/Onyxia and endgame dungeons, plus 500+ rebalanced items.
- **[Vanilla+](/servers/vanilla/)** — the PvP realm that lends its name to the whole category.

## The Ascension side

Ascension runs its own Vanilla+ seasons alongside its classless mainline — see [the classless explainer](/blog/ascension-classless-wow-explained/) for the full picture. [Bronzebeard](/servers/bronzebeard/) is the Vanilla+ realm, and [Conquest of Azeroth](/servers/conquest-of-azeroth/) runs custom classes on the same core.
