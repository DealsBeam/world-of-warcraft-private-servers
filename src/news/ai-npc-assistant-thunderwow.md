...
The feature runs on a consumable "Revelaciones" credit system (1,000 included with VIP), and the server also layers on ThunderPoints, a wallet, weekend XP/gold/crafting rate events and cross-server migrations. It's an early, small-scale example of the private-server scene starting to experiment with LLM-powered in-game assistants rather than relying on out-of-game wikis.