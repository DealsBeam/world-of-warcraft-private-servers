...
date: 2026-09-20
game: wow
description: "The first Forever addon census: Questie has a Forever release, Details is compatible, DBM is being ported, WeakAuras authors stopped, Blizzard ships built-in meter/cooldown/swing under Midnight API rules, and ClassicUI restores the 1.x interface."
...
SOURCES: wowforeverclassic addons guide (Sep 19); Warcraft Tavern ClassicUI report (Val Hull, Sep 19); Blizzard Q&A broadcast (Sep 17).
