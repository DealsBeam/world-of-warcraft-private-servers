---
title: "Forever beta verification hit list — 10 claims to check on Sep 17"
date: 2026-09-14
game: wow
description: "Every flagged Forever claim in one checklist for beta day: Onyxia's date, beta close discrepancy, dungeon names, Skyborne subtype names, Legacy ranks, Spearing Strike, Heroic price, 2027 fine print."
tags: [wow, blizzcon-2026, classic-plus, beta]
---

September 14, 2026 — The Forever beta opens **Thursday, September 17** (level 20 cap, rising to 30). Our coverage carries a running set of flagged claims. This is the consolidated hit list — what to check first when the client is dataminable, in priority order.
...
## Lower priority (beta can't fully answer)
