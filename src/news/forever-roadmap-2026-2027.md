...
September 13, 2026 — Blizzard's **2026-2027 World of Warcraft: Forever roadmap** is out with the panel recap, and it answers the question players have been circling since the reveal: how fast does a permanent Classic+ actually grow? The fine print spells out a launch raid set, a winter Hardcore window and two major 2027 content cadences.
...
The roadmap's second half lays out two content blocks.

**Spring 2027** brings two raids (a 10-player and a 20-player), two dungeons, more quests and playable area, a legendary questline, and a PvP refresh. The legendary questline is the first evergreen-endgame signal: Forever's cap stays 60, so legendary progression is the long-term character journey.

**Summer 2027** pairs a revamped iconic raid (Zierhut has since said Molten Core opens "someday, but not now," per The Sun interview) with another raid, two dungeons, expanded world content, and PvP, profession and Legacy updates. Summed up, that is three product seasons a year built on top of a fixed cap.

## What the roadmap says about the permanent cap

Every roadmap beat reinforces the "will always be 60" line from the reveal. Nothing raises the level cap. Instead, the roadmap expands horizontally: raids, dungeons, world content, professions and the Legacy progression system. That is the real answer to the old Classic+ design debate - the model is not "levels forever," it is "content forever at level 60."

The Forever Deep Dive recap (published September 13, the same route Blizzard uses for these panels) pins the surrounding systems: Forever is realmless with Normal, PvP, Roleplaying and Hardcore rulesets, Hardcore debuts after launch with a death-transfer path out to other rulesets, and spell/melee/ranged hit and crit are combined across combat. None of that moves the roadmap, but it confirms the December 9 wave sits on top of a unified, ruleset-based infrastructure rather than separate servers.

For private-server audiences the cadence matters too. A twice-a-year official content block at level 60 sets a pace that most Vanilla+ projects already struggle to match with volunteer teams. The roadmap is effectively Blizzard's answer to the custom-Core feature race documented on the [best Vanilla+ servers list](/blog/best-vanilla-plus-private-servers-2026/).
...
Roadmap per Blizzard's official panel recap and the 2026-2027 roadmap pinned post on the official forums, September 12 2026; fine print per classicwowforever.com transcription. The exact beta closing time has a one-day discrepancy (October 21 in purchase terms, October 22 on the roadmap graphic) that remains unresolved as of September 13.